    ...
    <div className="space-y-6 text-center">
      ...
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground mx-auto max-w-xl text-base">
          RPI membantu Anda menemukan lowongan kerja, mengikuti kursus, dan
          membangun karier. Mari kita atur akun Anda dalam beberapa langkah
          singkat.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-3 pt-2">
        ...
        >
          {isPending ? 'Memulai…' : 'Mari mulai'}
          <ArrowRight className="h-4 w-4" aria-hidden="true" />
        </button>
        <p className="text-muted-foreground text-xs">Hanya butuh sekitar 2 menit.</p>
      </div>
    </div>
  )
}
