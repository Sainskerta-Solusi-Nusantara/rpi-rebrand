# UIUX.md — Rumah Pekerja Indonesia (RPI)

Sistem desain RPI untuk platform SaaS multi-tenant. Identitas: **Premium Corporate Indonesia**. Dokumen ini adalah sumber kebenaran untuk warna, tipografi, spasi, komponen, dan tone — tim engineering & desain wajib merujuk ke sini.
...
export default {
  theme: {
    extend: {
      colors: {
        navy:   { 50:"#F0F4FA",100:"#DCE5F0",200:"#B5C4DC",300:"#8AA0C5",400:"#5F7DAD",500:"#3B5C8F",600:"#2A4470",700:"#1C3052",800:"#122036",900:"#0A2540",950:"#061528"},
        gold:   { 50:"#FBF7EE",100:"#F5ECD1",200:"#ECDBA4",300:"#E0C674",400:"#D4B14E",500:"#C9A961",600:"#A8893F",700:"#846A2E",800:"#604D22",900:"#3F3216",950:"#211A0B"},
        indigo: { 50:"#F0EFFF",100:"#DEDDFF",200:"#BFBCFF",300:"#9C97FF",400:"#7C76FF",500:"#635BFF",600:"#4F46E5",700:"#3E37B8",800:"#2D288A",900:"#1F1B66",950:"#110E3D"},
...
--shadow-md: 0 4px 8px -2px hsl(213 50% 15% / 0.10), 0 2px 4px -2px hsl(213 50% 15% / 0.06);
--shadow-lg: 0 12px 20px -4px hsl(213 50% 15% / 0.12), 0 4px 8px -4px hsl(213 50% 15% / 0.08);
--shadow-xl: 0 20px 36px -8px hsl(213 50% 15% / 0.15), 0 8px 12px -6px hsl(213 50% 15% / 0.10);
...
- **Primary**: wordmark "Rumah Pekerja Indonesia" + mark rumah-stilisasi.
...
Logo email: PNG 2x (retina), max width 160px, fallback alt "Rumah Pekerja Indonesia".
