    ...
    <div className="p-6 space-y-8 max-w-3xl">
      ...
      <header>
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-heading text-2xl md:text-3xl">Jadwalkan pemeliharaan</h1>
        </div>
        <p className="text-muted-foreground mt-1">
          Pemeliharaan akan langsung tampil di halaman publik dalam bagian
          &ldquo;Pemeliharaan mendatang&rdquo;.
        </p>
      </header>
