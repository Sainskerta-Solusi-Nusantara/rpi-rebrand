...
export const dictionary = {
  id: {
    ...
    hero: {
      eyebrow: 'Platform Karier #1 Indonesia',
      headline: 'Karier impian dimulai dari',
      headlineAccent: 'Rumah Pekerja Indonesia',
      ...
      ctaPrimary: 'Cari Kerja',
      ctaSecondary: 'Mulai Belajar',
      stats: {
        jobs: 'Lowongan',
        partners: 'Mitra',
        talents: 'Talenta',
      ...
      searchPlaceholder: 'Jabatan, perusahaan, atau kata kunci...',
      searchCta: 'Cari',
  ...
  en: {
    ...
    hero: {
      eyebrow: 'Indonesia’s #1 Career Platform',
      headline: 'Your dream career starts at',
      headlineAccent: 'Rumah Pekerja Indonesia',
      body: 'Discover thousands of verified jobs, certified training, and a supportive community for your professional journey — all under one roof.',
      ctaPrimary: 'Find a Job',
