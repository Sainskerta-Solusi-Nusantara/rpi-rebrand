...
export const home = {
  id: {
    ...
    successStories: {
      ...
      title: 'Ribuan Hidup Berubah Berkat SSN',
    ...
    newsletter: {
      ...
      subhead: 'Kurasi pilihan dari editor SSN...',
      emailLabel: 'Email',
    ...
    footer: {
      ...
      copyright: '© 2025 SSN Pekerja. All rights reserved.',
  ...
  en: {
    ...
    successStories: {
      ...
      title: 'Thousands of Lives Changed Through SSN',
    ...
    newsletter: {
      ...
      subhead: 'Curated picks from SSN editors...',
      emailLabel: 'Email',
