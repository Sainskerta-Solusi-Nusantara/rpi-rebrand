...
export const pagesPress = {
  id: {
    ...
    archive: {
      ...
      bodySuffix: 'SSN Pekerja. Untuk wawancara atau permintaan kustom, hubungi tim media kami.',
    ...
    category: {
      ...
      emptyBody: 'Jelajahi semua siaran pers SSN di halaman press.',
    ...
    tag: {
      ...
      emptyBody: 'Jelajahi semua siaran pers SSN.',
      emptyAction: 'Lihat semua siaran pers',
  ...
  en: {
    ...
    archive: {
      ...
      bodySuffix: 'SSN Pekerja. For interviews or custom requests, contact our media team.',
    ...
    category: {
      ...
      emptyBody: 'Browse all SSN press releases on the press page.',
    ...
    tag: {
      ...
      emptyBody: 'Browse all SSN press releases.',
      emptyAction: 'View all press releases',
