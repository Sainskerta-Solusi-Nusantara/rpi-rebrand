...
export const CAREER_TEAM_META: CareerTeamMeta[] = [
  { name: 'Engineering', slug: 'engineering', emoji: '⚛️', tagline: 'Membangun platform multi-tenant skala juta', description: 'Tim Engineering RPI mendesain dan menjalankan infrastruktur yang menopang 2,4 juta pencari kerja dan 12.000+ mitra perekrut. Anda akan bekerja dengan TypeScript, Go, Postgres, dan platform cloud-native untuk mengirim sistem yang stabil di skala produksi.' },
  { name: 'Design', slug: 'design', emoji: '🎨', tagline: 'Membentuk pengalaman pencari kerja & perekrut', description: 'Designer di RPI memiliki produk dari riset hingga ship. Tim ini meliputi product design (consumer, partner dashboard, LMS) dan brand/content design untuk publikasi RPI Insight.' },
  { name: 'Product', slug: 'product', emoji: '🎯', tagline: 'Mengarahkan strategi dan eksperimen produk', description: 'PM di RPI menggerakkan metrik, bukan sekadar mengirim fitur. Tim Product bertanggung jawab atas surface talent, partner, dan academy — masing-masing dengan dampak terukur pada KPI inti.' },
  ...
  { name: 'Support', slug: 'support', emoji: '💬', tagline: 'Suara RPI ke pengguna sehari-hari', description: 'Tim Support adalah lini depan empati. Selain menyelesaikan tiket, mereka menjadi sumber utama insight produk dari frustrasi nyata pengguna.' },
  { name: 'Academy', slug: 'academy', emoji: '📚', tagline: 'Mendesain jalur belajar yang dipekerjakan', description: 'RPI Academy mendesain kurikulum yang menerjemahkan kompetensi industri menjadi outcome belajar terukur. Tim ini bekerja erat dengan industri dan mitra perekrut.' },
